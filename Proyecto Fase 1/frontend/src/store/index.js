...
const ADMINISTRADORES = [
  {
    ...
    salario: 2500,
    descripcion:
      "Hace referencia a la persona con la más alta responsabilidad dentro de una empresa. Su visión global acerca de la compañía le permite definir con gran exactitud y precisión la visión, el propósito y la misión de la organización, premisas fundamentales que orientan la actividad diaria de cada empresa.",
    imagen:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/AlanBrito.jpg",
  },
  {
    numero: 2,
    nombre: "Esteban Dido",
  ...
  },
  {
    ...
    imagen:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/TomasAwita.jpg",
  },
  {
    numero: 4,
    nombre: "Susana Oria",
    puesto: "Gerente de Servicios Administrativos",
    salario: 4000,
    descripcion:
      "Dirige o coordina los servicios de apoyo de una organización como son el mantenimiento de los registros, el reparto del correo, los teléfonos, la recepción y otros servicios de apoyo administrativo. Pueden supervisar la planificación y el mantenimiento de las instalaciones, así como los servicios de custodia.",
    imagen:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/SusanaOria.jpg",
  },
  {
    numero: 5,
    ...
    imagen:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/AquilesBrinco.jpg",
  },
  {
    numero: 6,
    nombre: "Mario Neta",
    ...
    salario: 4200,
    descripcion:
      "Es la persona designada en una organización para coordinar un equipo con el propósito de alcanzar el objetivo deseado en el área comercial. Motiva y dirige a los demás integrantes para tomar las mejores decisiones y aumentar las ganancias de la empresa en la que se desenvuelven.",
    imagen:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/MarioNeta.jpg",
  },
  {
    numero: 7,
    nombre: "Elsy Lantro",
    ...
    salario: 4800,
    descripcion:
      "Planifica y coordina procedimientos y sistemas administrativos, así como idear modos de optimizar procesos, Contratar y formar personal, así como asignar responsabilidades y espacio en la oficina",
    imagen:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/ElsyLantro.jpg",
  },
];
...
const DESARROLLADORES = [
  ...
  { numero: 4, nombre: "EVELYN ALEJANDRA NAVARRO OZORIO", carnet: 201902046 },
...
const FUNCIONES = [
  {
    nombre: "Marco juridico",
    descripcion:
      "Resultan ser los preceptos en los que se sustenta el grueso de la regulación en materia de Función Pública.",
    enlace:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/FuncionPublica.jpg",
  },
  {
    nombre: "Estatuto Basico del Empleado Publico",
    descripcion:
      "El Estatuto Básico del Empleado Público tiene, en primer lugar, un carácter básico, en el que, de acuerdo con lo establecido en la Constitución Española, supone las bases del régimen estatutario de los funcionarios. Es por ello, que las Comunidades Autónomas, dentro de las competencias que tienen atribuidas.",
    enlace:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/EstatutoEmpleado.jpg",
  },
  {
    nombre: "Clasificacion del personal ",
    descripcion:
    ...
    enlace:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/ClasificacionPersonal.jpg",
  },
  {
    nombre: "Sistema de seleccion",
    descripcion:
      "Es el ordinario, consistente en la oposición, que como todos sabemos, se trata de la realización de una o varias pruebas de capacidad y aptitud en la que se evalúan las competencias del candidato para acceder a la Función Pública, y de conformidad con la puntuación obtenida, se establece un orden de prelación.",
    enlace:
      "https://redes2-proyectof1.s3.us-west-2.amazonaws.com/SistemaSeleccion.jpg",
  },
];
export default store(function (/* { ssrContext } */) {
  const Store = createStore({
    state: {
      useApi: process.env.USEAPI == "1",
      dominio: process.env.DOMINIO == "1",
      servername: "test",
    },
    actions: {
      GetAdministradores({ state }) {
        return new Promise((resolve, reject) => {
          if (state.useApi) {
            Axios.get("/administradores").then(({ data }) => {
              resolve(data);
            });
          } else {
      ...
      GetDesarrolladores({ state }) {
        return new Promise((resolve, reject) => {
          if (state.useApi) {
            Axios.get("/desarrolladores").then(({ data }) => {
              resolve(data);
            });
          } else {
            resolve(DESARROLLADORES);
          }
        });
      },
      GetGraficaData({ state }) {
        return new Promise((resolve, reject) => {
          if (state.useApi) {
            Axios.get("/estadisticas").then(({ data }) => {
              resolve(data);
            });
          } else {
