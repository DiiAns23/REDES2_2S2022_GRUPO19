...
- ## Ventas
  - ### PC0
    ```console
    ipconfig 192.168.81.2 255.255.255.192 192.168.81.1
    ```
  - ### PC4
    ```console
    ipconfig 192.168.81.3 255.255.255.192 192.168.81.1
    ```
  - ### PC7
    ```console
    ipconfig 192.168.81.4 255.255.255.192 192.168.81.1
    ```

- ## Distribucion
  - ### PC1
    ```console
    ipconfig 192.168.81.65 255.255.255.192 192.168.81.65
    ```
  - ### PC5
    ```console
    ipconfig 192.168.81.66 255.255.255.192 192.168.81.65
    ```
  - ### PC3
    ```console
    ipconfig 192.168.81.67 255.255.255.192 192.168.81.65
    ```

- ## Administracion
  - ### PC6
    ```console
    ipconfig 192.168.81.130 255.255.255.192 192.168.81.129
    ```
  - ### PC2
    ```console
    ipconfig 192.168.81.131 255.255.255.192 192.168.81.129
    ```

- ## Servidores
  - ### SERVER0
    ```console
    ipconfig 192.168.81.194 255.255.255.192 192.168.81.193
    ```
  - ### SERVER1
    ```console
    ipconfig 192.168.81.195 255.255.255.192 192.168.81.193
    ```
----------------------------------------------------------------------------
...
ip address 192.168.81.65 255.255.255.192
no shutdown
exit

int vlan 31
description Interfaz de enlace para vlan 31
ip address 192.168.81.129 255.255.255.192
no shutdown
exit

int vlan 41
description Interfaz de enlace para vlan 41
ip address 192.168.81.193 255.255.255.192
no shutdown
exit
```
...
|-------|-----------|----|-------- | ---------- | ----------- | --------- |
| 1 |	62 |	192.168.81.0 /26 |	255.255.255.192 |	192.168.81.1 |	192.168.81.62 |	192.168.81.63 |
| 2 |	62 |	192.168.81.64 /26 |	255.255.255.192 |	192.168.81.65 |	192.168.81.126 |	192.168.81.127 |
| 3 |	62 |	192.168.81.128 /26 |	255.255.255.192 |	192.168.81.129 |	192.168.81.190 |	192.168.81.191 |
| 4 |	62 |	192.168.81.192 /26 |	255.255.255.192 |	192.168.81.193 |	192.168.81.254 |	192.168.81.255 |
